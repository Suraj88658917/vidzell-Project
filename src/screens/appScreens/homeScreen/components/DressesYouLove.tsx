...
const DressesCard = ({ item }: { item: DressesItem }) => {
...
const DressesYouLove = () => {
  return (
    <View style={styles.container}>

      <Text style={styles.heading}>Dresses You’ll Love</Text>

      <FlatList
        data={data}
        keyExtractor={(item) => item.id}
        renderItem={({ item }) => <DressesCard item={item} />}
        horizontal
